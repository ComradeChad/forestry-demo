...
_Audience:_ other COMP 3040 students

_Venue:_ a website like Geeks for Geeks

_Purpose:_ Instruct the audience on how to use the basic components of Regular Expressions.

_Additional Purpose:_ Encourage the student to learn more about regular expressions, or try their own.

_Desired Reaction:_ Understanding of the basic componments of regular expressions, confident that they can apply the regular expression elements outlined.

_Vocabulary:_ General programming jargon, JavaScript syntax for code examples. Vocabulary that a college-level student should have no trouble understanding.

_Tone:_ Brief, concise, to-the-point.

## _Examples:_ A code or regex example of syntax or expected regex matches for every topic introduced.
